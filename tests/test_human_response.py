...
class TestHumanResponseFormatting:
    ...
    def test_format_human_success(self, mock_get_client, mock_get_config, mock_open, mock_exists):
    ...
    @patch('adoc_toolkit.config.get_config_manager')
    @patch('adoc_toolkit.llm.client.get_llm_client')
    def test_format_human_llm_error(self, mock_get_client, mock_get_config, mock_open, mock_exists):
